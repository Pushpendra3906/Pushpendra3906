...
// }
// console.log(seconDalargest([1, 2, 9, 11]));
...
//   return num2;
// }
// const arr = [1, 2, 3, 4, 5, 99, 6, 98];
// console.log(secondLargest(arr));

//*******Shift all zeros in starting of array******** */

// let arr = [0, 0, 1, 0, 2, 6, 0, 100];
// arr.sort();
// const pp = arr.map((num) => {
//   return num;
// });
...
// let arr=[12,0,1,0,2,6,0,0,100]
// arr.sort();
// // const pp=arr.map((num)=>{return(num)})
// // arr.reverse()    // to shift all 0 to right
// console.log(arr);

// let arr = [0, 0, 1, 2, 6, 0, 100];
// let arr1 = [];
// var num = 0;
// for (var i = 0; i < arr.length; i++) {
//   if (arr[i] == 0) {
